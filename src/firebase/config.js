...
const apiKey = import.meta.env.VITE_FIREBASE_API_KEY || "your-api-key-here";
const authDomain =
...
const appId = import.meta.env.VITE_FIREBASE_APP_ID || "your-app-id";
const measurementId =
...
if (apiKey === "your-api-key-here") {
  console.warn(
    "⚠️ Firebase is using placeholder values. Please set up your Firebase credentials in a .env file or replace the placeholder values in src/firebase/config.js"
  );
}
